...
exports.websocket_port = exports.port = void 0;
...
(0, websocket_server_1.default)(exports.websocket_port, websocket_handler_1.handle_room_message);
// DATA SERVER
// Serves JSON data
...
app.listen(exports.port, '0.0.0.0', () => {
    ...
    console.log(`Connect at http://localhost:${exports.port}/`);
});
