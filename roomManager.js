...
exports.liveRooms = [
    ...
    new classes_1.Room('test-room-3', new classes_1.User('test-user-3'), true),
    ...
    new classes_1.Room('test-room-6', new classes_1.User('test-user-6'), true),
    ...
    new classes_1.Room('test-room-9', new classes_1.User('test-user-9'), true)
];
